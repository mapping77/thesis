...
\begin{figure}[!htbp]
    ...
    \bicaption{图A表示降低势阱的示意图。降低一侧势阱深度使原子漏出来制备少体体系。图B为实验测到的少体体系平均粒子数与方差。 摘自 \citep{SerwaneDeterministic} }{Fig A for illustration of spilling. Lowering potential of one side for atoms spilling in order to preapare few body system. Fig B for measured mean density and variance. Reprinted from\citep{SerwaneDeterministic} }
    \label{deter}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
