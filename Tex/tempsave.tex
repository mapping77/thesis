...
\begin{figure}[!htbp]
    ...
    \bicaption{拟合Raman谱得到的准粒子剩余$Z$。摘自\cite{Sagi2020}}{Quasiparticle residue obtained from fitting measured Raman Spectrum. Reprinted from\cite{Sagi2020}}
    \label{fpsmooth}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \bicaption{单粒子空穴近似下的吸引极化子与排斥极化子能量。摘自\cite{massignan2014polarons}}{Energy of attractive and repulsive fermi polarons under 1 p-h approximation. Reprinted from\cite{massignan2014polarons}}
    \label{fpchevyE}
\end{figure}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{chap1pmE.png}
    \bicaption{极化子-分子转变。摘自\cite{Punk_pm}}{Polaron-molecule transition. Reprinted from\cite{Punk_pm}}
    \label{pmE}
\end{figure}
